            ...
            <div className="py-14 md:py-20 lg:max-w-7xl md:w-[90%] mx-auto px-4 overflow-hidden">
                <div className="flex flex-col gap-11 lg:flex lg:flex-row lg:gap-0 items-center">
                    ...
                    >
                        ...
                        <br />
                        <p className="text-xl sm:text-3xl lg:text-4xl text-cyan-500 mb-9 dark:text-cyan-300">
                        ...
                        <motion.a
                            ...
                            href={Resume}
                            className="inline-block text-base md:text-xl font-medium mt-8 text-white bg-cyan-600 px-5 py-2 md:px-7 md:py-3 rounded-md "
                            target="_blank"
                            rel="noreferrer"
                        >
                            Download Resume
