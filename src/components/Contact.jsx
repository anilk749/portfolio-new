...
const Contact = () => {
  ...
  // Reset the form after successful submition
  useEffect(() => {
          ...
          <>
            ...
            <Toast
              className={`absolute top-1/2 left-0 right-0 z-30 mx-auto ${
                isFormSubmitted ? "text-green-700" : "text-red-700"
              }`}
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="max-w-xl mx-auto flex flex-col gap-4">
            ...
            <motion.button
              ...
              className="w-full md:w-1/2 ms-auto p-3 mt-3 text-lg text-white font-medium bg-cyan-600 rounded-full shadow-lg shadow-cyan-600/50 hover:bg-cyan-700 hover:shadow-cyan-800/50"
              type="submit"
            >
              Send Message
            </motion.button>
